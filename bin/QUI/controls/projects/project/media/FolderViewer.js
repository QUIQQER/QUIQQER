    ...
    return new Class({
        ...
        create: function() {
            ...
            this.$MediaSettings.getContextMenu(function(Menu) {
                Menu.addEvent('onShow', function() {
                    ...
                    const newMenuPos = this.$MediaSettings.getElm().getPosition().x - width + 60;
        ...
        refresh: function() {
            ...
            return Media.get(this.getAttribute('folderId')).then(function(Item) {
                ...
                return Item.getChildren(false, {
                    ...
                    if (files === 0) {
                        let message = QUILocale.get(lg, 'projects.project.media.folderviewer.empty');

                        if (!allowedTypes.contains('image')) {
                            message = QUILocale.get(lg, 'projects.project.media.fileviewer.empty');
                        }
            ...
            new QUIButton({
                ...
                events: {
                    onClick: () => {
                        ...
                        this.$Folder.uploadFiles(Files).then((uploadedFiles) => {
                            if (!this.getAttribute('autoactivate')) {
                                this.refresh();
                                return;
                            }
        ...
        $autoActivate: function(url) {
            return new Promise((resolve) => {
                ...
                QUIAjax.post('ajax_media_activate', () => {
                    this.refresh();
                    resolve();
                }, {
