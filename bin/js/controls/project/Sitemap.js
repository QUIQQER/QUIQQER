...
], function(QUI_Control, QUI_Sitemap)
{
     ...
     * A project sitemap
     *
     * @class QUI.controls.project.Sitemap
     *
     * @fires onOpenBegin [Item, this]
     * @fires onOpenEnd [Item, this]
     * @param {Object} options
     */
    QUI.controls.project.Sitemap = new Class({

        Implements : [ QUI_Control ],
        Type       : 'QUI.controls.project.Sitemap',
         ...
         *
         * @method QUI.controls.project.Sitemap#getMap
         *
         ...
         *
         * @method QUI.controls.project.Sitemap#create
         *
         * @return {DOMNode}
         */
        create : function()
         ...
         * Open the Map
         *
         * @method QUI.controls.project.Sitemap#open
         */
        open : function()
        {
            if ( !this.$Elm ) {
         ...
         *
         * @method QUI.controls.project.Sitemap#openSite
         *
         ...
         *
         * @method QUI.controls.project.Sitemap#getSelectedChildren
         * @return {Array}
         */
         ...
         *
         * @method QUI.controls.project.Sitemap#getFirstChild
         *
         ...
         *
         * @method QUI.controls.project.Sitemap#$getSite
         *
         ...
         *
         * @method QUI.controls.project.Sitemap#$addSitemapItem
         *
         ...
         *
         * @method QUI.controls.project.Sitemap#$close
         *
         * @param {QUI.controls.sitemap.Item} Item
         *
         * @private
    ...
    return QUI.controls.project.Sitemap;
});
