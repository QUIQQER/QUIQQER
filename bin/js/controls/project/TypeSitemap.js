...
define('controls/project/TypeSitemap', [
...
], function(Control, QUI_Item, QUI_SitemapItem)
{
    ...
    /**
     * @class QUI.controls.project.TypeSitemap
     *
     * @fires onItemClick
     ...
     */
    QUI.controls.project.TypeSitemap = new Class({

        Implements : [ Control ],
        Type       : 'QUI.controls.project.TypeSitemap',
         ...
         *
         * @method QUI.controls.project.TypeSitemap#open
         */
        open : function()
        {
         ...
         *
         * @method QUI.controls.project.TypeSitemap#getValues
         * @return {Array}
         */
        getValues : function()
        {
    ...
    return QUI.controls.project.TypeSitemap;
});