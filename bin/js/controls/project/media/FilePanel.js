...
define('controls/project/media/FilePanel', [

    'controls/Control',
    'controls/Utils',
    'controls/project/media/PanelDOMEvents',

    'css!controls/project/media/FilePanel.css'
...
], function(QUI_Control)
{
     ...
     *
     * @class QUI.controls.project.media.FilePanel
     *
     * @param {QUI.classes.project.media.File} File
     * @param {Object} options
     */
    QUI.controls.project.media.FilePanel = new Class({

        Implements : [ QUI_Control ],
        Type       : 'QUI.controls.project.media.FilePanel',
         ...
         *
         * @method QUI.controls.project.media.FilePanel#close
         */
        close : function()
        {
            this.destroy();
         ...
         *
         * @method QUI.controls.project.media.FilePanel#create
         */
        create : function()
        {
         ...
         * Saves the files
         *
         * @method QUI.controls.project.media.Panel#save
         */
        save : function()
        {
            var File = this.$File,
         ...
         * Delete the files
         *
         * @method QUI.controls.project.media.Panel#del
         */
        del : function()
        {
         ...
         * Activate the file
         *
         * @method QUI.controls.project.media.Panel#activate
         */
        activate : function()
        {
         ...
         *
         * @method QUI.controls.project.media.Panel#replace
         */
        replace : function()
        {
         ...
         *
         * @method QUI.controls.project.media.FilePanel#$createTabs
         */
    ...
    return QUI.controls.project.media.FilePanel;
});