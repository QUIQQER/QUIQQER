 ...
 *
 * @module controls/project/media/PanelDOMEvents
 * @package com.pcsg.qui.js.controls.project.media.PanelDOMEvents
 * @namespace QUI.controls.project.media
 */

define('controls/project/media/PanelDOMEvents', [
...
], function()
{
    ...
    QUI.controls.project.media.PanelDOMEvents = new Class({
         ...
         *
         * @method QUI.controls.project.media.PanelDOMEvents#activateItem
         ...
         *
         * @method QUI.controls.project.media.PanelDOMEvents#deactivateItem
         * @param {Array} DOMNode List
         */
         ...
         *
         * @method QUI.controls.project.media.PanelDOMEvents#renameItem
         ...
         * replace a file
         *
         * @method QUI.controls.project.media.PanelDOMEvents#replace
         * @param {DOMNode} DOMNode
         */
    ...
    return QUI.controls.project.media.PanelDOMEvents;
});