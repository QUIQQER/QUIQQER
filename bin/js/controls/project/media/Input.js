 ...
 * @requires controls/project/media/Button
 *
 * @module controls/project/media/Input
 * @package com.pcsg.qui.jscontrols.projects.media
 * @namespace QUI.controls.projects.media
 */

define('controls/project/media/Input', [

    'controls/Control',
    'controls/project/media/Button',

    'css!controls/project/media/Input.css'
...
], function(Control, QUI_MediaButton)
{
    ...
    /**
     * @class QUI.controls.project.media.Input
     *
     ...
     */
    QUI.controls.project.media.Input = new Class({

        Implements: [ Control ],
        Type      : 'QUI.controls.project.media.Input',
         ...
         * Create the button
         *
         * @method QUI.controls.project.media.Input#create
         * @return {DOMNode}
         */
        create : function()
        {
            ...
            new QUI.controls.project.media.Button({
                events :
                {
         ...
         *
         * @method QUI.controls.project.media.Input#loadTypeName
         */
        load : function()
        {
            if ( this.$Input.value === '' )
         ...
         * Return the value
         *
         * @method QUI.controls.project.media.Input#getValue
         * @return {String}
         */
        getValue : function()
        {
         ...
         * Set the value
         *
         * @method QUI.controls.project.media.Input#setValue
    ...
    return QUI.controls.project.media.Input;
});