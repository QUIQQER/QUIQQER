 ...
 *
 * @module controls/project/media/Manager
 * @package com.pcsg.qui.js.controls.project.media
 * @namespace QUI.controls.project.media
 */

define('controls/project/media/Manager', [

    'controls/desktop/Panel',
    'controls/buttons/Button',

    'css!controls/project/media/Manager.css'
...
], function(QUI_Panel)
{
     ...
     *
     * @class QUI.controls.project.media.Manager
     *
     * @param {Object} options
     */
    QUI.controls.project.media.Manager = new Class({

        Implements : [QUI_Panel],
        Type       : 'QUI.controls.project.media.Manager',
         ...
         *
         * @method QUI.controls.project.media.Manager#create
         */
        $onCreate : function()
        {
            this.Loader.show();
    ...
    return QUI.controls.project.media.Manager;
});
