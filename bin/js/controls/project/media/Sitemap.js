...
], function(QUI_Control, QUI_Sitemap)
{
     ...
     * A media sitemap
     *
     * @class QUI.controls.project.media.Sitemap
     *
     ...
     */
    QUI.controls.project.media.Sitemap = new Class({
         ...
         *
         * @method QUI.controls.project.media.Sitemap#getMap
         *
         ...
         *
         * @method QUI.controls.project.media.Sitemap#create
         *
         * @return {DOMNode}
         */
        create : function()
         ...
         * Open the Map
         *
         * @method QUI.controls.project.media.Sitemap#open
         */
        open : function()
        {
            if ( !this.$Elm ) {
         ...
         *
         * @method QUI.controls.project.media.Sitemap#selectChildrenByValue
         ...
         *
         * @method QUI.controls.project.media.Sitemap#getChildrenByValue
         *
         ...
         *
         * @method QUI.controls.project.media.Sitemap#getSelectedChildren
         * @return {Array}
         */
         ...
         *
         * @method QUI.controls.project.media.Sitemap#$getSite
         *
         ...
         *
         * @method QUI.controls.project.media.Sitemap#$parseArrayToSitemapitem
         *
         * @param {Array} result
         ...
         *
         * @method QUI.controls.project.media.Sitemap#$addSitemapItem
         *
    ...
    return QUI.controls.project.media.Sitemap;
});
