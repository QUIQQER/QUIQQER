 ...
 * @requires controls/project/media/Sitemap
 * @requires controls/grid/Grid
 * @requires controls/project/media/PanelDOMEvents
 * @requires controls/project/media/PanelContextMenu
 * @requires controls/upload/Form
 *
 * @event onDragDropComplete [this, event]
 *
 * @module controls/project/media/Panel
 * @package com.pcsg.qui.js.controls.project
 * @namespace QUI.controls.project.media
 */

define('controls/project/media/Panel', [
    ...
    'controls/grid/Grid',
    'controls/project/media/PanelDOMEvents',
    'controls/project/media/PanelContextMenu',
    'controls/upload/Form',

    'css!controls/project/media/Panel.css'
...
], function(QUI_Control, QUI_Media, QUI_Upload, QUI_MediaSitemap)
{
     ...
     *
     * @class QUI.controls.project.media.Panel
     *
     * @param {QUI.classes.project.Media} Media
     * @param {Object} options
     */
    QUI.controls.project.media.Panel = new Class({

        Implements : [ QUI_Control ],
        Type       : 'QUI.controls.project.media.Panel',
        ...
        initialize : function(Media, options)
        {
            ...
            this.$DOMEvents   = new QUI.controls.project.media.PanelDOMEvents( this );
            this.$ContextMenu = new QUI.controls.project.media.PanelContextMenu( this );
         ...
         *
         * @method QUI.controls.project.media.Panel#close
         */
        close : function()
        {
            this.destroy();
         ...
         *
         * @method QUI.controls.project.media.Panel#create
         */
        create : function()
        {
         ...
         *
         * @method QUI.controls.project.media.Panel#load
         */
        load : function()
        {
            this.$Panel.Loader.show();
         ...
         * Refresh the Panel
         *
         * @method QUI.controls.project.media.Panel#openID
         */
        refresh : function()
        {
        ...
        openID : function(fileid)
        {
            ...
            this.$Media.get(fileid, function(MediaFile, Request)
            {
                ...
                if ( MediaFile.getType() !== 'QUI.classes.project.media.Folder' )
                {
         ...
         *
         * @return {QUI.classes.project.Media} Media
         */
        getMedia : function()
        {
            return this.$Media;
         ...
         *
         * @return {QUI.classes.project.media.Folder} Folder
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#showSitemap
         */
         ...
         * Hide the Sitemap
         *
         * @method QUI.controls.project.media.Panel#hideSitemap
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#uploadFiles
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#uploadArchive
         */
         ...
         * Download the file
         *
         * @method QUI.controls.project.media.Panel#downloadFile
         ...
         * Create the Sitemap
         *
         * @method QUI.controls.project.media.Panel#$createSitemap
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#$createBreadCrumb
         * @params {array} items
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#$resizeSheet
         */
         ...
         * list the children
         *
         * @method QUI.controls.project.media.Panel#$viewSymbols
         ...
         *
         * @method QUI.controls.project.media.Panel#$viewSymbolClick
         ...
         *
         * @method QUI.controls.project.media.Panel#$viewSymbolMouseDown
         * @param {DOMEvent} event
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#$viewSymbolMouseUp
         * @param {DOMEvent} event
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#$viewDetails
         *
         * @params {array} children
         * @params {DOMNode} Container - Parent Container for the DOMNodes
         * @return {array} the drop-upload-list
         ...
         *
         * @method QUI.controls.project.media.Panel#createFolder
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#activateItem
         ...
         *
         * @method QUI.controls.project.media.Panel#deactivateItem
         * @param {DOMNode} DOMNode
         *
         ...
         *
         * @method QUI.controls.project.media.Panel#deleteItem
         * @param {DOMNode} DOMNode
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#deleteItems
         * @param {Array} DOMNode List
         */
         ...
         * Rename the folder
         *
         * @method QUI.controls.project.media.Panel#renameItem
         * @param {DOMNode} DOMNode
         */
         ...
         *
         * @method QUI.controls.project.media.Panel#replaceItem
         * @param {DOMNode} DOMNode
         */
