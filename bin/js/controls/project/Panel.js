...
define('controls/project/Panel', [
    ...
    'css!controls/project/Panel.css'
...
], function(QUI_Control, QUI_Projects, QUI_ProjectSitemap)
{
    ...
    /**
     * @class QUI.controls.project.Panel
     * @param {Object} options
     */
    QUI.controls.project.Panel = new Class({

        Implements : [ QUI_Control ],
        Type       : 'QUI.controls.project.Panel',
         ...
         *
         * @method QUI.controls.project.Panel#$onCreate
         */
        $onCreate : function()
        {
            this.getBody().set(
         ...
         *
         * @method QUI.controls.project.Panel#createList
         */
        createList : function()
        {
            if ( this.$Map ) {
         ...
         *
         * @method QUI.controls.project.Panel#openProject
         */
         ...
         *
         * @method QUI.controls.project.Panel#selectSitemapItemById
         *
         ...
         *
         * @method QUI.controls.project.Panel#getSitemapItemsById
         *
         * @return {Array}
         */
         ...
         *
         * @method QUI.controls.project.Panel#openSite
         *
    ...
    return QUI.controls.project.Panel;
});