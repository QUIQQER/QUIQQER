...
], function(QUI_Control)
{
    ...
    /**
     * @class QUI.controls.projects.Input
     *
     ...
     * @memberof! <global>
     */
    QUI.controls.projects.Input = new Class({

        Extends : QUI_Control,
        Type    : 'QUI.controls.projects.Input',
        ...
        search : function()
        {
            QUI.Ajax.get('ajax_project_search', function(result, Request)
            {
    ...
    return QUI.controls.projects.Input;
});