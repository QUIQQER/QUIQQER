 ...
 *
 * @module controls/projects/media/PanelContextMenu
 * @package com.pcsg.qui.js.controls.projects.media.PanelContextMenu
 * @namespace QUI.controls.projects.media
 */

define('controls/projects/media/PanelContextMenu', [
...
], function()
{
    ...
    QUI.controls.projects.media.PanelContextMenu = new Class({
         ...
         *
         * @method QUI.controls.projects.media.PanelContextMenu#createPanelMenu
    ...
    return QUI.controls.projects.media.PanelContextMenu;
});