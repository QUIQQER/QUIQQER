...
MUI.append({
    ...
    registered: new Hash(),
    idCount: 0,
    ieSupport: false, //'excanvas',                    // Makes it easier to switch between Excanvas and Moocanvas for testing
    ...
    initialize: function(options)
    {
        ...
        {
            if (options.path) {
                options.path = Object.append( MUI.options.path, options.path );
            }
            if ( options.css ) {
                options.css = Object.append( MUI.options.css, options.css );
            }
...
var NamedClass = function(name, members)
{
    ...
    {
        if (cName == this.className) {
            return true;
        }

        if (!this.constructor || !this.constructor.parent) {
            return false;
        }
...
Element.implement({
    ...
    shake: function(radius, duration){
        ...
        var morph = this.retrieve('morph') || new Fx.Morph(this);
        var oldOptions;
        if (morph){
            morph.cancel();
    ...
    hide: function()
    {
        ...
        if (typeof instance.hide !== 'undefined')
        {
            instance.hide();
            return this;
        }
    ...
    show: function()
    {
        ...
        if (typeof instance.show !== 'undefined')
        {
            instance.show();
            return this;
        }
