...
define('mocha/Controls/window/window', [

    'mocha/Controls/desktop/desktop',
    'mocha/Controls/dock/dock',
    'mocha/Controls/toolbar/toolbar'
    ...
    MUI.Window.implement({
        ...
        draw: function(){
            ...
            */
            ...
            if (options.y){
                ...
                if (MUI.desktop){
                    y = (dimensions.y * 0.5) - (this.el.windowEl.offsetHeight * 0.5);
                    if (y < -options.shadowBlur) y = -options.shadowBlur;
                } else {
                    y = window.getScroll().y + (window.getSize().y * 0.5) - (this.el.windowEl.offsetHeight * 0.5);
                    if (y < -options.shadowBlur) y = -options.shadowBlur;
                }
            }

            if (this.options.x === null){
                x = (dimensions.x * 0.5) - (this.el.windowEl.offsetWidth * 0.5);
            ...
            */
            ...
            this.opacityMorph = moofx( this.el.windowEl );
            ...
            */
            this.morph = moofx( this.el.windowEl );
            ...
            if (this.taskbar && this.options.type == 'window') this.taskbar.createTask(this);
        ...
        redraw: function(shadows){
            ...
            if (this.useCSS3) this._css3SetStyles();
                ...
                if (this.options.useCanvas && !Browser.ie8){
                    // Draw Window
        ...
        resize: function(options){
            ...
            var top, left;
            if (options.centered){
                top = typeof(options.top) != 'null' ? options.top : oldTop - ((options.height - oldHeight) * 0.5);
                left = typeof(options.left) != 'null' ? options.left : oldLeft - ((options.width - oldWidth) * 0.5);
            } else {
        ...
        hideSpinner: function()
        {
            if ( this.el.spinner ) {
                ...
                this.el.spinner.setStyle('display', 'none');
            }
            return this;
        },
        ...
        showSpinner: function()
        {
            if ( this.el.spinner ) {
                ...
                this.el.spinner.setStyle('display', 'inline');
            }
            return this;
        },
        ...
        close: function(){
            ...
            } else
            {
                ...
                if ( (this.options.type == 'modal' || this.options.type == 'modal2') &&
                     $$('.modal').length < 2 )
                {
                    MUI.Modal.modalOverlayCloseMorph.animate({
                        opacity : 0
                    }, {
                        callback : function()
                        {
                ...
                */
                ...
                moofx( this.el.windowEl ).animate({
                    opacity : 0.4
                }, {
                    callback : function() {
                        this._doClosingJobs();
        ...
        _insertWindowElements: function(){
            ...
            if (options.icon){
                cache.title.setStyles({
                    'padding-left': 28,
                    'background': 'url(' + options.icon + ') 5px center no-repeat'
                });
            }
        ...
        _showNewWindow: function(){
            ...
            if (options.type == 'modal' || options.type == 'modal2'){
                ...
                if (MUI.options.advancedEffects){
                    ...
                    MUI.Modal.modalOverlayOpenMorph.animate({
                        'opacity': 0.6
                    });
                    this.el.windowEl.setStyle('zIndex', 11000);
                    this.opacityMorph.animate({
                        'opacity': 1
                    });
                } else {
                ...
                this.opacityMorph.animate({'opacity': 1});
                this.focus.delay(10, this);
            } else {
