 ...
 * @requires MUI.Desktop
 * @requires MUI.Column
 *
 * provides: [MUI.Panel]
 *
 * @event onLoaded [this]    // called every time content is loaded using MUI.Content
 * @event onDrawBegin [this]
 * @event onDrawEnd [this]
 * @event onResize [this]
 * @event onCollapse [this]
 * @event onExpand [this]
 * @event onClose [this]
 * @event onOpen [this]
 */

define('mocha/Controls/panel/panel', [

    'mocha/Controls/desktop/desktop',
    'mocha/Controls/column/column',
    'controls/loader/Loader',
    'mocha/Controls/apppanel/apppanel'
...
], function()
{
    MUI.Panel = new NamedClass('MUI.Panel', {
        ...
        options: {
            ...
            position   : 'bottom',  // where to insert
        ...
        draw: function(container)
        {
            ...
            if ( !div )
            {
                ...
                }).inject( container, options.position );
            }
            ...
            if ( options.height > container_height ) {
                options.height = container_height;
            }
            ...
            // loader
            this.Loader.inject( this.el.element );
            ...
            this.sections.each(function(section)
            {
                ...
                {
                    if ( section.loadMethod == 'iframe' ) {
                        section.padding = 0;  // Iframes have their own padding.
                    }
                ...
                if ( section.position == 'header' ) {
                    headerItems.unshift( section );
                }

                if ( section.position == 'footer' ) {
                    footerItems.unshift( section );
                }
            }, this);
            ...
            if ( options.header )
            {
                ...
                if ( options.collapsible )
                {
                    ...
                    headerItems.unshift({
                        content : this.el.collapseToggle,
                        divider : false
                    });
                }
                ...
                if ( options.title )
                {
                    ...
                    headerItems.push({
                        id          : options.id + 'headerContent',
                        content     : this.el.title,
                        orientation : 'left',
                        divider     : false
                    });
                }
            ...
            if ( options.footer )
            {
                this.el.footer = new Element('div', {
                    ...
                    'class'  : 'panel-footer',
                    'styles' : {
                        'display': options.footer ? 'block' : 'none'
                    }
            ...
            */
            ...
            container.getChildren('.panelWrapper')
                     .removeClass('bottomPanel')
                     .getLast()
                     .addClass('bottomPanel');

            MUI.panelHeight( container, this.el.panel, 'new' );

            Object.each(this.el, (function(ele)
            {
                if ( ele != this.el.headerToolbox ) {
        ...
        close: function()
        {
            ...
            if ( panels.length > 0 ) {
                panels.getLast().addClass('bottomPanel');
            }
        ...
        /**
         * Opens the Panel if the Panel is not open
         *
         * @method MUI.Panel#open
         */
        open: function()
        {
            if ( this.el.panel.getSize().x !== 0 ) {
                return this;
            }
        ...
        _collapse: function(fireevent)
        {
            ...
            if ( this.el.footer )
            {
                ...
                if ( options.collapseFooter ) {
                    this.el.footer.hide().setStyle( 'height', 0 );
                }
            }
        ...
        expand: function()
        {
            ...
            if ( this.el.footer && this.options.collapseFooter ) {
                this.el.footer.setStyle( 'height', this.oldFooterHeight ).show();
            }
            ...
            if ( this.options.column &&
                 (Col = MUI.get(this.options.column)) && Col.isCollapsed )
            {
                Col.expand();
            }
