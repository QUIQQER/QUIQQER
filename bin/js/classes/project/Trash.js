...
], function(QDOM)
{
    ...
    /**
     * @class QUI.classes.project.Trash
     *
     ...
     */
    QUI.classes.project.Trash = new Class({

        Implements : [ QDOM ],
        Type       : 'QUI.classes.project.Trash',
        ...
        getControl : function()
        {
            return new QUI.controls.project.Trash(
                this.$Project,
                this.getAttributes(),
                this
            );
         ...
         *
         * @method QUI.classes.project.Trash#destroy
         *
         ...
         *
         * @method QUI.classes.project.Trash#restore
         *
