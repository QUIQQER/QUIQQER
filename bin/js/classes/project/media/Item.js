 ...
 * @requires controls/project/media/FilePanel
 *
 * @module classes/project/media/Item
 * @package com.pcsg.qui.js.classes.project.media.Item
 * @namespace QUI.classes.project.media
 */

define('classes/project/media/Item', [

    'classes/DOM',
    'controls/project/media/FilePanel'

], function(DOM, QUI_FilePanel)
{
     ...
     */
    QUI.classes.project.media.Item = new Class({

        Implements: [DOM],
        Type      : 'QUI.classes.project.media.Item',
         ...
         *
         * @method QUI.classes.project.media.Item#openInPanel
         * @params {MUI.Apppanel} Panel - optional
         */
        openInPanel : function(Panel)
        {
            this.$Panel = new QUI.controls.project.media.FilePanel( this );
        },

        /**
         * Returns the Media Object of the item
         *
         * @method QUI.classes.project.media.Item#getMedia
        ...
        {
            if ( this.getType() === 'QUI.classes.project.media.Folder' ) {
                return;
            }
         ...
         *
         * @method QUI.classes.project.media.Item#getId
         * @return {Integer}
         */
        getId : function()
        {
         ...
         *
         * @method QUI.classes.project.media.Item#getBreadcrumb
         * @param {Function} oncomplete - callback Function
         */
        getBreadcrumb : function(oncomplete)
        {
            QUI.Ajax.get('ajax_media_breadcrumb', function(result, Request)
            {
         ...
         *
         * @method QUI.classes.project.media.Item#save
         * @fires onSave [this]
        ...
        save : function(oncomplete, params)
        {
            ...
            QUI.Ajax.post('ajax_media_file_save', function(result, Request)
            {
         ...
         * Delete the item
         *
         * @method QUI.classes.project.media.Item#del
         *
         * @fires onDelete [this]
         *
         * @param {Function} oncomplete - [optional] callback Function
         ...
         * Activate the File
         *
         * @method QUI.classes.project.media.Item#activate
         *
         ...
         * Deactivate the File
         *
         * @method QUI.classes.project.media.Item#deactivate
         *
         ...
         * Download the image
         *
         * @method QUI.classes.project.media.Item#download
         */
        download : function()
        {
            if ( this.getType() === 'QUI.classes.project.media.Folder' ) {
            ...
            var url = QUI.Ajax.$url +'?'+ QUI.Ajax.parseParams('ajax_media_file_download', {
                project : this.getMedia().getProject().getName(),
                fileid  : this.getId()
            });
         ...
         *                              onfinish( {QUI.classes.project.media.Item} )
         */
         ...
         *
         * @method QUI.classes.project.media.Item#isActive
         * @return {Bool}
         */
        isActive : function()
        {
         ...
         * Rename the folder
         *
         * @method QUI.classes.project.media.Folder#rename
         *
        ...
        rename : function(newname, oncomplete, params)
        {
            ...
            QUI.Ajax.post('ajax_media_rename', function(result, Request)
            {
                Request.getAttribute('oncomplete')( result, Request );
            }, params);
        }
    ...
    return QUI.classes.project.media.Item;
});