...
class QUI_Plugins_Manager extends QDOM
{
    /**
     * loaded plugins
     * @var array
	...
	{
		$list   = Utils_System_File::readDir( OPT_DIR );
		$result = array();
	...
	{
	    $Config = $this->_Config; /* @var $Config QConfig */
	...
	protected function _getCache($class)
	{
		...
		if ( !class_exists( $class ) ) {
		    throw new QException('Konnte Plugin '. $class .' nicht laden');
		}
	...
	public function existPlugin($plugin)
	{
        ...
        throw new QException( 'Plugin nicht gefunden', 404 );
	}
	...
	public function getPlugin($plugin)
	{
        ...
        throw new QException( 'Plugin nicht verfügbar', 403 );
	}
	...
	public function getTypeName($type)
	{
	    ...
	    throw new QException( 'Type not found', 404 );
	}
