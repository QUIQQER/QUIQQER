...
/**
 * This file contains the Projects_Site
 */
...
class Projects_Site extends QDOM
{
	...
	public function __construct(Projects_Project $Project, $id)
	{
		...
		// Falls ein PHP Cache vorhanden ist dann dies nutzen anstatt das Filesystem
        try
        {
            $this->decode(
                System_Cache_Manager::get( $this->_CACHENAME )
            );
	...
	{
		return 'Object Site('. $this->getAttribute('name') .')';
	}
	...
	/**
	 * Gibt ein Attribute zurück
	 *
	 * @param String $attribute - wanted attribute
	...
	{
		$this->_plugins = Projects_Sites::getPlugins($this);
	}
