...
class Utils_Api_Amazon extends QDOM
{
	/**
	 * Constructor
	 *
	...
	public function __construct(array $settings)
	{
		if (!isset($settings['secret_key_id'])) {
			throw new QException('No Private Key given', 401);
		}

		if (!isset($settings['access_key_id'])) {
			throw new QException('No Access Key given', 401);
		}
	...
	/**
	 * Parse the DOM result in an QDOM items
	 *
	...
	/**
	 * Parse DOM ImageSets in QDOM items
	 * Only Screenshots
	 *
	 * @param DOMDocument $DOM
	 * @return Array
