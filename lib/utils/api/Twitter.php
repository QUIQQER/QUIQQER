...
class Utils_Api_Twitter extends QDOM
{
    /**
	...
	public function __construct($params=array())
	{
		...
		if ( $this->getAttribute( 'cachefolder' ) )
		{
			...
			Utils_System_File::mkdir( $this->_cachefolder );
		}
	...
	public function send($message)
	{
		...
		if ( strlen( $message ) > 140 ) {
			throw new QException( 'Deine Nachricht ist länger als 140 Zeichen' );
		}

		if ( strlen( $message ) <= 0 ) {
			throw new QException( 'Du hast keine Nachricht angegeben' );
		}
