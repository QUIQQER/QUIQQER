...
<head>
	...
	<script type="text/javascript" src="<?php echo URL_BIN_DIR; ?>js/mvc/require.js"></script>
	<script type="text/javascript" src="<?php echo URL_BIN_DIR; ?>js/mootools/mootools-core-1.4.5.js"></script>
