-- phpMyAdmin SQL Dump
-- version 3.4.8deb1.lucid~ppa.1
-- http://www.phpmyadmin.net
--
-- Host: localhost:3306
-- Erstellungszeit: 16. Mrz 2012 um 21:23
...
--
-- Datenbank: `hen_namerobot`
--

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `pcsg_countries`
--

DROP TABLE IF EXISTS `pcsg_countries`;
CREATE TABLE IF NOT EXISTS `pcsg_countries` (
...
--
-- Daten für Tabelle `pcsg_countries`
--

INSERT INTO `pcsg_countries` (`countries_id`, `countries_name`, `countries_iso_code_2`, `countries_iso_code_3`, `address_format_id`, `de`, `en`) VALUES
