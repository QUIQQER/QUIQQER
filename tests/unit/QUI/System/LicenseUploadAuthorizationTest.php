...
final class LicenseUploadAuthorizationTest extends TestCase
{
    private const AJAX_FUNCTION = 'ajax_licenseKey_upload';
    ...
    protected function setUp(): void
    {
        ...
        QUI::$Ajax = new Ajax();
        require dirname(__DIR__, 4) . '/admin/ajax/licenseKey/upload.php';
    }
